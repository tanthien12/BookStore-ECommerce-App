...
//                         <img
//                             src={b.image || `https://placehold.co/200x200?text=${encodeURIComponent(b.title.slice(0, 18))}`}
//                             alt={b.title}
//                             className="w-full h-[140px] object-cover rounded-t-2xl"
//                             onError={(e) => { e.currentTarget.src = `https://placehold.co/200x200?text=${encodeURIComponent(b.title.slice(0, 18))}`; }}
//                         />
//                         <div className="p-3">
...
//                                 <button
//                                     onClick={() => onAction("add_to_cart", b)}
...
//     // state message bây giờ có thể là { sender, text } hoặc { sender, type:'products', payload:{items} }
//     function appendMessage(sender, content) {
//         // content: string | {type, payload}
...
//                                                         onAction={(act, book) => {
//                                                             if (act === "add_to_cart") {
//                                                                 // Đơn giản: nhờ AI thực hiện tool add_to_cart
//                                                                 handleSend(`Thêm vào giỏ sách "${book.title}" (ID: ${book.id})`);
//                                                             } else if (act === "similar") {
//                                                                 handleSend(`Gợi ý tương tự: ${book.title} (${book.author || "không rõ"})`);
//                                                             } else if (act === "under_200k") {
//                                                                 handleSend(`Sách dưới 200k tương tự với "${book.title}"`);
//                                                             }
//                                                         }}
//                                                     />
//                                                 ) : (
