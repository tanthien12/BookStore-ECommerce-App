...
// // Gần với DB orders + order_items + users
// const MOCK_ORDERS = [
//     {
//         id: "ODR-10001",
...
// const COL_KEY = "admin.orders.table.columns";
...
//     // toggle cột (nhớ bằng localStorage)
//     const [showCols, setShowCols] = useState(() => {
//         const saved = localStorage.getItem(COL_KEY);
//         return saved
//             ? JSON.parse(saved)
//             : { order: true, customer: true, total: true, payment: true, status: true, createdAt: true };
//     });
...
//         };
//         const onEsc = (e) => { if (e.key === "Escape") setOpenColMenu(false); };
...
//     // chọn theo trang (select all + indeterminate)
...
//                                     </div>
//                                 </th>
//                                 {showCols.order && <th className="p-3 text-left">Order</th>}
//                                 {showCols.customer && <th className="p-3 text-left">Customer</th>}
//                                 {showCols.total && <th className="p-3 text-left">Total</th>}
//                                 {showCols.payment && <th className="p-3 text-left">Payment</th>}
//                                 {showCols.status && <th className="p-3 text-left">Status</th>}
//                                 {showCols.createdAt && <th className="p-3 text-left">Created At</th>}
...
//                                                 <span className={`inline-flex items-center px-2 py-0.5 rounded-full border text-xs ${PAY_BADGE[o.paymentStatus] || "bg-gray-100 text-gray-700 border-gray-200"}`}>
//                                                     {o.paymentStatus}
//                                                 </span>
//                                             </td>
//                                         )}
