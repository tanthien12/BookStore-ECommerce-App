...
// class tailwind dùng chung cho input / select
const INPUT_FOCUS =
    "focus:outline-none focus:ring-1 focus:ring-red-500 focus:border-red-500";
const INPUT_BASE =
    "w-full rounded-lg border border-gray-200 px-3 py-2.5 text-sm " + INPUT_FOCUS;
...
export default function Profile() {
        ...
        try {
            ...
            if (file) {
                ...
                const up = await fetch(
                    summaryApi.url(summaryApi.upload.user.single),
                    {
                        method: "POST",
                        headers: { ...authHeaders() },
                        body: fd,
            ...
            setForm((s) => ({
                ...s,
                avatar_url: u?.avatar_url || finalUrl || "",
            }));
            setFile(null);
            if (preview) {
    ...
    return (
        <div className="space-y-5">
            ...
            <form
                onSubmit={onSave}
                className="rounded-2xl border border-gray-200 bg-white p-5 space-y-6"
            >
                {/* Header trong card */}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-1">
                        <div className="rounded-xl border border-gray-200 p-4 flex flex-col items-center gap-4 bg-gray-50/60">
                            <img
                                src={avatarSrc}
                                alt="avatar"
                                className="w-28 h-28 rounded-full object-cover border"
                            />
                            <label className="inline-flex items-center gap-2 px-3 py-2 rounded-lg border border-gray-300 hover:bg-gray-100 cursor-pointer text-sm font-medium">
                                <FiUpload />
                                Thay ảnh
                                <input
                                    type="file"
                    ...
                    <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="col-span-1">
                            ...
                            <div className="relative">
                                ...
                                />
                                <FiUser className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 text-gray-400" />
                            </div>
                        </div>
                        ...
                        <div className="col-span-1">
                            ...
                            <div className="relative">
                                ...
                                />
                                <FiMail className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 text-gray-400" />
                            </div>
                        </div>
                        ...
                        <div className="col-span-1">
                            ...
                            <div className="relative">
                                ...
                                />
                                <FiPhone className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 text-gray-400" />
                            </div>
                        ...
                        <div className="col-span-1">
                            ...
                            <div className="relative">
                                ...
                                {/* mũi tên của select do browser vẽ, nên không cần icon riêng */}
                            </div>
                        </div>
                        ...
                        <div className="col-span-1 md:col-span-2 flex justify-end mt-2">
                            <button
                                type="submit"
                                disabled={loading}
                                className="inline-flex items-center gap-2 rounded-xl bg-red-600 px-5 py-2.5 text-white text-sm font-semibold hover:bg-red-700 disabled:opacity-70"
                            >
