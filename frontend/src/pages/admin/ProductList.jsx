...
//     // sync paging when filters/search change
//     useEffect(() => {
//         setPage(1);
//     }, [query, filters.category, filters.stock, filters.priceMin, filters.priceMax]);
...
//     // broadcast & listen admin:search events
//     useEffect(() => {
//         if (typeof window === "undefined") return undefined;
//         const handler = (event) => {
//             const nextValue = typeof event?.detail?.query === "string" ? event.detail.query : "";
...
//     // visible (local) filters
//     const visibleItems = useMemo(() => {
//         return items.filter((b) => {
//             const stockNumber = Number(b.stock);
//             if (filters.stock === "out" && stockNumber > 0) return false;
//             if (filters.stock === "low" && stockNumber > 20) return false;
//             if (filters.stock === "in" && stockNumber <= 20) return false;

//             if (filters.priceMin && Number(b.price) < Number(filters.priceMin)) return false;
//             if (filters.priceMax && Number(b.price) > Number(filters.priceMax)) return false;

//             if (filters.category && Array.isArray(b.categories)) {
//                 const match = b.categories.some((c) => String(c.id) === String(filters.category));
//                 if (!match) return false;
//             } else if (filters.category && b.category_id && String(b.category_id) !== String(filters.category)) {
//                 return false;
//             }
...
//     const activeFilterCount = useMemo(
//         () => [filters.category, filters.stock, filters.priceMin, filters.priceMax].filter(Boolean).length,
//         [filters]
//     );
...
//                             >
//                                 <div>
//                                     <label className="mb-1 block text-sm font-medium text-gray-600">Danh mục</label>
//                                     <select
//                                         value={filterDraft.category}
...
//                                 </div>
//                                 <div>
//                                     <label className="mb-1 block text-sm font-medium text-gray-600">Tồn kho</label>
//                                     <select
//                                         value={filterDraft.stock}
//                                         onChange={(e) => setFilterDraft((prev) => ({ ...prev, stock: e.target.value }))}
//                                         className="w-full rounded-lg border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
//                                     >
//                                         <option value="">Tất cả</option>
//                                         <option value="in">Còn hàng (&gt; 20)</option>
...
//                                 <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
//                                     <div>
//                                         <label className="mb-1 block text-sm font-medium text-gray-600">Giá tối thiểu</label>
//                                         <input
//                                             type="number"
//                                             min={0}
//                                             value={filterDraft.priceMin}
//                                             onChange={(e) => setFilterDraft((prev) => ({ ...prev, priceMin: e.target.value }))}
//                                             className="w-full rounded-lg border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
//                                         />
//                                     </div>
//                                     <div>
//                                         <label className="mb-1 block text-sm font-medium text-gray-600">Giá tối đa</label>
//                                         <input
//                                             type="number"
//                                             min={0}
//                                             value={filterDraft.priceMax}
//                                             onChange={(e) => setFilterDraft((prev) => ({ ...prev, priceMax: e.target.value }))}
//                                             className="w-full rounded-lg border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
//                                         />
//                                     </div>
//                                 </div>
...
//                         <tbody className="divide-y">
//                             {loading ? (
//                                 <tr><td colSpan={columnCount} className="p-8 text-center text-gray-500">Đang tải…</td></tr>
//                             ) : visibleItems.length === 0 ? (
//                                 <tr><td colSpan={columnCount} className="p-8 text-center text-gray-500">Không có sách nào.</td></tr>
//                             ) : (
//                                 visibleItems.map((b) => {
//                                     const s = stockLabel(b.stock);
//                                     const barClass = stockBarClass(b.stock);
...
//                                                                 {b.title}
//                                                             </Link>
//                                                             <div className="text-xs text-gray-500">#{b.slug || b.isbn || b.id}</div>
//                                                         </div>
//                                                     </div>
//                                                 </td>
//                                             )}
...
//                                                         <div className={`text-sm font-medium ${s.color}`}>{s.text}</div>
//                                                         <div className="ml-3 w-28 h-2 rounded-full bg-gray-200 overflow-hidden">
//                                                             <div className={`h-2 ${barClass}`} style={{ width: `${pct}%` }} />
//                                                         </div>
//                                                     </div>
//                                                 </td>
...
//                                             {showCols.price && (
//                                                 <td className="p-3 font-medium text-emerald-600">{toVND(b.price)}</td>
//                                             )}
...
//                         )}
//                         {hasLocalFilters && (
//                             <div className="text-xs text-gray-400">* Một số bộ lọc áp dụng trên dữ liệu trong trang hiện tại.</div>
//                         )}
//                     </div>
//                     <div className="flex items-center gap-2">
//                         <button
